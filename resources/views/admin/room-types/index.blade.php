        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title d-flex justify-content-between">Room Types <a href="{{ route('admin.room-types.create') }}" class="text-success">Add Room Type <i class="fa fa-plus"></i></a></h3>
