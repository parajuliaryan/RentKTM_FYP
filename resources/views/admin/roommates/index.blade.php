    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        <h3 class="box-title d-flex justify-content-between">Roommates List<a
                                href="{{ route('admin.roommates.create') }}" class="text-success">Add Roommate <i
                            ...
                            <table class="table text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <a href="{{ route('admin.roommates.edit',$roommate->id) }}"><i
                                                    class="fa fa-edit"></i></a>
                                            <a href="{{ route('admin.roommates.show', $roommate->id) }}"><i
                                                    class="fa fa-eye"></i></a>
                                            <form action="{{route('admin.roommates.destroy',$roommate->id)}}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
